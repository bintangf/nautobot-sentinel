...
### DJANGO-REDIS_SENTINEL MODE !!!!!!!!!

DJANGO_REDIS_CONNECTION_FACTORY = "django_redis.pool.SentinelConnectionFactory"
CACHES = {
    "default": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": "redis://redismaster/0",  # in this context 'nautobot' is the redis master/service name
        "OPTIONS": {
...
### CELERY SENTINEL MODE !!!!!!!!!!!

redis_password = ""
sentinel_password = ""

CELERY_BROKER_URL = (
    f"sentinel://:{redis_password}@35.219.31.168:26379;"
    f"sentinel://:{redis_password}@35.219.87.87:26379;"
    # The final entry must not have the `;` delimiter
    f"sentinel://:{redis_password}@35.219.94.104:26379"
)
